            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group mb-4">
                        ...
                        <li class="list-group-item"><strong>Телефон:</strong> <?php echo e($user->phone ?? 'Не указан'); ?></li>
                        <li class="list-group-item"><strong>Адрес:</strong> <?php echo e($user->address ?? 'Не указан'); ?></li>
                        <!-- Если в будущем добавятся телефон и адрес, их можно будет сюда добавить -->
                    </ul>
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-success">Редактирование профиля</a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\zigan\Library-system\library-system\resources\views/profile/index.blade.php ENDPATH**/ ?>