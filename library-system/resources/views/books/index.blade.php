                            ...
                            @foreach($books as $book)
                                <div class="col-md-6 col-lg-4 mb-4">
                                    <div class="card h-100">
                                        @if($book->cover_url)<!-- Показ обложки -->
                                        ...
                                        @endif
                                        <div class="card-body d-flex flex-column"><!-- Краткие сведения о книге -->
                                            <h5 class="card-title">{{ $book->title }}</h5>
                                            <p class="card-text"><small class="text-muted">Автор: {{ $book->author }}</small></p>
                                            <p class="card-text flex-grow-1">{{ Str::limit($book->description, 100) }}</p><!-- Краткое описание лимит 100 символов -->
